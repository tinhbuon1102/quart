										...
										<tr>
											...
											<td>
												<textarea name="<?php echo $suffix_name . "[table_note_apply_to]" ?>"
												          id="<?php echo $suffix_id . "[table_note_apply_to]" ?>"><?php echo isset( $db_value[ $key ]['table_note_apply_to'] ) ? esc_attr( stripslashes($db_value[ $key ]['table_note_apply_to'])) : '' ?></textarea>
											</td>
											<th>
												<?php
												//@since 1.1.0
											...
											<td>
												<textarea
													...
													id="<?php echo $suffix_id . "[table_note_adjustment_to]" ?>"><?php echo isset( $db_value[ $key ]['table_note_adjustment_to'] ) ? esc_attr( stripslashes($db_value[ $key ]['table_note_adjustment_to'])) : '' ?></textarea>
											</td>
										</tr>
										<tr class="deps-discount_mode" data-type="bulk">
											<th>
											...
											<td>
												<textarea name="<?php echo $suffix_name . "[table_note]" ?>"
												          id="<?php echo $suffix_id . "[table_note]" ?>"><?php echo isset( $db_value[ $key ]['table_note'] ) ? esc_attr( stripslashes($db_value[ $key ]['table_note'])) : '' ?></textarea>
											</td>
										</tr>
									</table>
								</td>
