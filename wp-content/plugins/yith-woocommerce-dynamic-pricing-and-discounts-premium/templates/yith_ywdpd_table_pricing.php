        ...
        <tr>
            ...
            <?php foreach ( $rules as $rule ):
                ...
                if ( $product->is_type('variable') ) {
	                ...
	                if ( YITH_WC_Dynamic_Pricing_Helper()->valid_product_to_apply_bulk( $main_rule, $product, false ) ) {
...
<?php
add_filter( 'woocommerce_'.YITH_WC_Dynamic_Pricing_Frontend()->get_product_filter.'get_price', array( YITH_WC_Dynamic_Pricing_Frontend(), 'get_price' ) );