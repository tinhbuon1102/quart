...
if ( $intro = get_option( 'woocommerce_email_mbc_cpaido_intro' ) ) :

 echo wpautop( wp_kses_post( wptexturize( apply_filters( 'woocommerce_email_mbc_cpaido_intro_filter', $intro ) ) ) );

else : ?>
	             	
<p><?php printf( __( "Hi there. Your recent order on %s has been paid. Your order details are shown below for your reference:", 'woocommerce' ), get_option( 'blogname' ) ); ?></p>
