...
$link_product = false;
$optlink_product = get_option( 'woocommerce_email_mbc_linkproduct');
if($optlink_product == 'yes')
$link_product = true;
...
$pstyle = "style=\"font-family: ".$bodyFont."; box-sizing: border-box; font-size: $bodyfontsize;color : $text;$textalign\"";
$listyle = "style=\"font-family: ".$bodyFont."; box-sizing: border-box; font-size: $bodyfontsize; margin: 0; padding: 0;color : $text;$textalign\"";
