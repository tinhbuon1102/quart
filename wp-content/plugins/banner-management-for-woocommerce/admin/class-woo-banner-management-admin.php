...
class Woo_Banner_Management_Admin {
    ...
    public function enqueue_styles() {
         ...
         * class.
         */
        if (isset($_GET['page']) && !empty($_GET['page']) && ($_GET['page'] == "banner-setting" || $_GET['page'] == "banner-management-for-woocommerce")) {
    ...
    public function my_custom_submenu_page_callback() {
        ...
        <div class="notice notice-success is-dismissible" id="succesful_message_wbm" style="display:none"><p><?php _e('Banner saved succesfully', 'succes-message'); ?></p></div>
        <div class="woocommerce-banner-managment-setting-content">
            <div class="plugin_title_content"><h2>Banner Management Settings </h2>
                <p>You can easily add banner in WooCommerce stores and you can upload the banner for page specific, category specific and welcome page specific.</p>
                <p>You can upload custom banner  at the top of your product category pages. Easily update the image through your product category edit page.</p>
            </div>
            <fieldset class="wbm_global">	
                <legend><div class="wbm-setting-header"><h2>Page specific banner</h2></div></legend>
                <p>You can upload custom banner on page specific. Easily update the image and redirect page URL from below setting option.</p>
                <div class="accordion">
            ...
            <fieldset class="wbm_global">	
                <legend><div class="wbm-setting-header"><h2>Category specific banner</h2></div></legend>
    ...
    public function welcome_benner_mamagement_for_woocommerce_screen_do_activation_redirect() {
        ...
        wp_safe_redirect(add_query_arg(array('page' => 'banner-management-for-woocommerce&tab=about'), admin_url('index.php')));
    }
