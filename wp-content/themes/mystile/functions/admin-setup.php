...
function woo_output_custom_css() {
	...
	if ( file_exists( get_template_directory() . '/custom.css' ) ) {
		echo "\n" . '<!-- Custom Stylesheet -->' . "\n" . '<link href="'. esc_url( get_template_directory_uri() . '/custom.css?t=' . filemtime(get_template_directory() . '/custom.css' ) ) . '" rel="stylesheet" type="text/css" />' . "\n";
	}
	...
	if ( is_child_theme() && file_exists( get_stylesheet_directory() . '/custom.css' ) ) {
		if ( file_exists( get_stylesheet_directory() . '/custom.css' ) ) {
			echo "\n" . '<!-- Custom Stylesheet In Child Theme -->' . "\n" . '<link href="'. esc_url( get_stylesheet_directory_uri() . '/custom.css?t=' . filemtime(get_stylesheet_directory() . '/custom.css' ) ) . '" rel="stylesheet" type="text/css" />' . "\n";
		}
	}
